...
// TODO: change name to StackBot?
export const botName = "eng-dev-bot[bot]";
const baseBotCommand = "/stackbot";

export type Command = "squash" | "merge" | "fold";
...
export function isCommand(command: string): command is Command {
  return ["squash", "merge", "fold"].includes(command);
}
